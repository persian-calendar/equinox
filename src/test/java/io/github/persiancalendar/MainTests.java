...
public class MainTests {
    ...
    public final void test_not_change(int year, int month, int day, int hour, int minute, int second) {
        Calendar calendar = Calendar.getInstance(TimeZone.getTimeZone("Asia/Tehran"));
        calendar.setTime(Equinox.NORTHWARD_EQUINOX.inYear(year));
    ...
    @Test
    public final void test_other_equinoxes() {
